...
var quizQuestions = [{
    ...
    correctAnswer: "b"},
  {
    ...
    correctAnswer: "b"},
   {
    ...
    choiceD: "To initiate a computer restart",
    correctAnswer: "a"},  
    {
...
/*On click of the submit button, we run the function highscore that saves and stringifies the array of high scores 
already saved in local stoage as well as pushing the new user name and score into the array we are saving in local storage. 
